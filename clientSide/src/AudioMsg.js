...
function AudioMsg(props) {
    console.log("hello im audiomsg")
    ...
    */
    ...
    React.useEffect(() => {
        ...
        executeAfterPageLoads();
    }, []);

    return (
        <div>
            <div class="audio-recording-container">
                <i class="start-recording-button fa fa-microphone" aria-hidden="true">  Start Recording</i>
                <div class="recording-contorl-buttons-container hide">
                    <i class="cancel-recording-button fa fa-times-circle-o" aria-hidden="true">  Cancel Recording</i>
                    <div class="recording-elapsed-time">
                        <i class="red-recording-dot fa fa-circle" aria-hidden="true"></i>
                        <p class="elapsed-time"></p>
                    </div>
                    <i class="stop-recording-button fa fa-stop-circle-o" aria-hidden="true">  Send Audio Message</i>
                </div>
            ...
            <audio hidden controls class="audio-element hide">
            </audio > 
        </div>
